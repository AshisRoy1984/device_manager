    ...
    <section className="section dashboard">
      ...
      {userRole === 'GlobalSuperuser' && (
          ...
          <Link to="/registered-devices">
            <div className="card info-card registered-device">              
              <div className="card-body">
                <h5 className="card-title">Registered Devices</h5>
                <div className="d-flex align-items-center">
                  <div className="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    <i className="bi bi-hdd-network-fill"></i>
                  </div>
                  <div className="ps-3">
                    <h6>{registered_devices}</h6>                   
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-xxl-4 col-xl-12">
          <Link to="/unregistereddevices">
            <div className="card info-card unregistered-device">              
              <div className="card-body">
                <h5 className="card-title">Unregistered Devices</h5>
                <div className="d-flex align-items-center">
                  <div className="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    <i className="bi bi-hdd-network-fill"></i>
                  </div>
                  <div className="ps-3">
                    <h6>{unregistered_devices}</h6>                   
                  </div>
                </div>
              </div>
            </div>
