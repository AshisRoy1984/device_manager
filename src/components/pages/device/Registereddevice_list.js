...
const Registereddevice_list = (props)=>{   
    ...
    const fetchData = async (page)=>{ 
        ...
        const res = await Api.registered_devices({
            ...
            product_line:filterData.product_line,
            device_type:filterData.device_type,

            country:filterData.country,
            device_location:filterData.device_location,
            deptunit:filterData.deptunit,
            threshold:filterData.threshold,
            trigger:filterData.trigger,
                                ...
                                <table className="table table-hover table-striped">
                                    <thead>
                                        <tr className="table-active">
                                            ...
                                            <th scope="col" className="text-uppercase">Dept Unit</th>  
...
export default Registereddevice_list;
