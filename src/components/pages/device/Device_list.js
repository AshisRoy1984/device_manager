                                ...
                                <table className="table table-hover table-striped">
                                    <thead style={{backgroundColor:"#EAF0F0"}}>
                                        <tr className="table-active">
                                            ...
                                            <th scope="col" className="text-uppercase">Unit</th>                        
                                    ...
                                    { loader ? 
                                        ...
                                        {data && data.length > 0 ?
                                            data.map((doc,index) => ( 
                                                <tr key={index}>
                                                    ...
                                                    <th className="text-center">
                                                        ...
                                                        <Link title="View Data" style={{cursor:"pointer"}} to={`/sensor-data/${doc.DeviceIntID}`} >
                                                        <i className="bi bi-clipboard-data text-primary"></i> View Data
                                                        </Link> 

                                                        <div className="vr"></div>

                                                        <Link title="Edit Device" style={{cursor:"pointer"}} to={`/edit-device/${doc.DeviceIntID}`} >
                                                        <i className="bi bi-pencil-square text-primary"></i>
                                                        </Link>  

                                                        <div className="vr"></div> 
                                                    
                                                        <Link title="Delete" style={{cursor:"pointer"}} to={`/edit-company/${doc.DeviceIntID}`} >
                                            ...
                                            <tr>
                                                ...
                                                <th>Building A</th>     
                                                <th>Celsius</th>                
                                                <th>{all_function.getFormattedDate('2-6-1988')}</th>  
                                                <th className="text-center">
                                                {
                                                    0==0 ?
                                                ...
                                                <th className="text-center">
                                                    ...
                                                    <Link title="Sensor Data" style={{cursor:"pointer"}} to={`/sensor-data/1`} >
                                                    <i className="bi bi-clipboard-data text-primary"></i> Sensor Data
                                                    </Link> 

                                                    <div className="vr"></div>

                                                    <Link title="Edit Device" style={{cursor:"pointer"}} to={`/edit-device/1`} >
                                                    <i className="bi bi-pencil-square text-primary"></i>
                                                    </Link> 

                                                    <div className="vr"></div> 
                                                    
                                                    <Link title="Delete" style={{cursor:"pointer"}} to={`/edit-company/1`} >
                                                    <i className="bi bi-trash text-danger"></i>
                                                    </Link>                                          
                                                </th>                                                               
                                            </tr>
