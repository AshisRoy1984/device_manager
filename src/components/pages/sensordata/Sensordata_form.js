...
const Sensordata_form = (props)=>{ 
  ...
  return (   
    ...
    <div className="pagetitle">
        <h1>
        {
          DeviceIntID ? 'Edit Sensor Data' : 'Add Sensor Data'
        }      
        </h1>
        <nav>
        <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item"><Link to="/sensor-data/1">Sensor Data</Link></li>
            <li className="breadcrumb-item active">
            {
              DeviceIntID ? 'Edit' : 'Add'
            }      
            </li>
        </ol>
        </nav>
...
export default Sensordata_form;
