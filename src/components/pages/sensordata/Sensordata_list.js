...
const Sensordata_list = (props)=>{   
    ...
    <div className="pagetitle">
        ...
        <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item"><Link to="/device">Device List</Link></li>
            <li className="breadcrumb-item active">Sensor Data</li>
        </ol>
        </nav>
    </div>
                        ...
                        <div className="col-md-4">
                            <div className="d-flex justify-content-end">    
                                <div className="group ps-2 ps-md-4">                            
                                    <Link className="btn btn-secondary radius-50 px-3" to="/add-sensor-data/1">+ Add New</Link>  
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            data.map((doc,index) => ( 
                                                <tr key={index}>
                                                    ...
                                                    <th className="text-center">
                                                        ...
                                                        <Link title="View Data" style={{cursor:"pointer"}} to={`/device-data/${doc.DeviceIntID}`} >
...
export default Sensordata_list;
