                                        ...
                                        {data && data.length > 0 ?
                                            data.map((doc,index) => ( 
                                                <tr key={index}>
                                                    ...
                                                    <th className="text-center">
                                                        ...
                                                        <Link title="View Devices" style={{cursor:"pointer"}} to={`/view-company/${doc.DeviceIntID}`} >
                                                        <i className="bi bi-clipboard-data text-primary"></i> Devices
                                                        </Link> 

                                                        <div className="vr"></div> 

                                                        <Link title="Edit" style={{cursor:"pointer"}} to={`/edit-company/${doc.DeviceIntID}`} >
                                            ...
                                            <tr>
                                                ...
                                                <th className="text-center">
                                                        ...
                                                        <Link title="View Devices" style={{cursor:"pointer"}} to={`/view-company/1`} >
                                                        <i className="bi bi-clipboard-data text-primary"></i> Devices
                                                        </Link> 

                                                        <div className="vr"></div> 

                                                        <Link title="Edit" style={{cursor:"pointer"}} to={`/edit-company/1`} >
                                                        <i className="bi bi-pencil-square text-primary"></i>
                                                        </Link>  
